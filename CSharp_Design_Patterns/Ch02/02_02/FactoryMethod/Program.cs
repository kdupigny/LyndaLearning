...
namespace FactoryMethod
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"My citi balance is ${citiAcct.Balance} of type {citiAcct.GetType().ToString()}\n" +
                              $"My national balance is ${nationalAcct.Balance} of type {nationalAcct.GetType().ToString()}");
        }
